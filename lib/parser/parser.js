...
LuaComment
  = '--' (whitespace* !(newline / whitespace) .)* { return textNode('lua:comment', location(), text()); }
...
Comment
  = '#' (whitespace* !(newline / whitespace) .)* { return textNode('comment', location(), text()); }
